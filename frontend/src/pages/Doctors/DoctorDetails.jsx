...
const DoctorDetails = () => {
  ...
  return (
    <section>
      <div className="max-w-[1170px] px-5 mx-auto  mt-20 ">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text_para text-[14px] md:text-[15px] leading-6 lg:max-w-[390px]">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et!</p>
              </div>
            </div>
