  ...
  return (
    <div>
        <div>
            ...
            <p className='text_para'> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe, nisi pariatur amet impedit praesentium incidunt esse deleniti similique eligendi recusandae reprehenderit ipsa rem labore repellat explicabo hic sunt cupiditate odio!</p>
        </div>
        ...
        <div className='mt-12'>
            ...
            <ul className='pt-4 md:p-5'>
                <li className='flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px]'>
                    <div>
                        <span className='text-irisBlueColor text-[15px] leading-6 font-semibold'>{formateDate('09-13-2010')}-{formateDate('09-13-2016')}</span>
        ...
        <ul className='grid sm:grid-cols-2 gap-[30px] pt-4 md:p-5'>
            <li className='p-4 rounded bg-[#fff9ea]'>
                <span className='text-yellowColor tetx-[15px] leading-6 font-semibold'>{formateDate('09-13-2010')}-{formateDate('09-13-2014')}</span>
