...
const Home = () => {
  return (
    <>
      {/* -----------------------------hero-section---------------------- */}
      <section className="hero_section pt-[20px]  2xl:h-[600px]">
            ...
            <div>
              <div className=" lg:w-[570px]">
                ...
                <p className=" text_para">
                  ...
                  error deserunt, asperiores tempore dolor iusto id eius
                  explicabo. Voluptate iste veritatis tempore explicabo laborum
                  vel libero voluptates molestiae sapiente cupiditate?
                </p>
              ...
              {/* --------hero counter----------- */}
              <div
                className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:
              gap-[30px]"
              >
                <div>
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px] ">
              ...
              <ul className="pl-4">
                ...
                <li className="text_para">
                  ...
                  online scheduling tool to select and appoitment time.
                </li>
              </ul>
              <Link to="/">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              <img src={featureImg} className="w-[70%]" alt="" />
      ...
      <section>
        <div className="container ">
          <div className="flex justify-start gap-[50px] lg:gap-0">
